...
import { Loader2, Plus, Package, Inbox } from "lucide-react";
  ...
  const categoryOptions = useMemo(
    () =>
      [
        ...
        { value: "retail_stock", label: "Retail stock" },
        { value: "equipment", label: "Equipment" },
        { value: "packaging", label: "Packaging" },
        { value: "consumables", label: "Consumables" },
        { value: "other", label: "Other" },
      ] as const satisfies ReadonlyArray<{ value: PurchaseCategory; label: string }>,
    []
  );
        ...
        <Card className="glass shadow-xl rounded-[2rem] border-amber-500/10 overflow-hidden relative">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <CardDescription className="text-base mt-1">
                  Add inventory, equipment, and stock purchases.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent className="p-8 space-y-10">
            ...
            <div className="bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 p-6 shadow-sm">
              <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-6">New Purchase Entry</h3>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <FormItem className="sm:col-span-2 lg:col-span-3">
                          ...
                          <FormControl>
                            <Input 
                              ...
                              className="rounded-xl bg-background border-border/50 h-11 shadow-sm transition-all focus:bg-background/80 focus-visible:ring-amber-500/20" 
                              {...field} 
                              disabled={submitting} 
                            />
                          </FormControl>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Input 
                              ...
                              step="any" 
                              placeholder="10" 
                              className="rounded-xl bg-background border-border/50 h-11 text-lg font-medium shadow-sm transition-all focus:bg-background/80 focus-visible:ring-amber-500/20" 
                              {...field} 
                              disabled={submitting} 
                            />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Total Amount</FormLabel>
                          <FormControl>
                            <Input 
                              type="number" 
                              inputMode="decimal" 
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">Recent Purchases</h3>
                <Button 
                  type="button" 
                  variant="ghost" 
                  size="sm"
                      ...
                      <div className="flex items-center gap-4 min-w-0">
                        ...
                        <div className="min-w-0">
                          <div className="truncate font-semibold text-foreground text-base">
                            {it.itemName} <span className="text-muted-foreground font-normal text-sm ml-1">x {it.quantity} {it.unit}</span>
                          </div>
                          <div className="flex items-center gap-2 text-xs text-muted-foreground mt-0.5">
                            ...
                            <span>•</span>
                            <span className="truncate max-w-[120px]">{it.supplier}</span>
                            <span>•</span>
                            <span>{formatDate(it.purchasedAt)}</span>
                          </div>
                        </div>
                      </div>
